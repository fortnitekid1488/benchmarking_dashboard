...
set "REPO_URL=https://github.com/fortnitekid1488/benchmarking_dashboard.git"
set "ZIP_URL=https://github.com/fortnitekid1488/benchmarking_dashboard/archive/refs/heads/main.zip"

echo Updating Financial Benchmark dashboard from GitHub main...
echo Folder: %CD%
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$zip = Join-Path $env:TEMP ('benchmarking-dashboard-main-' + [guid]::NewGuid() + '.zip');" ^
  "$tmp = Join-Path $env:TEMP ('benchmarking-dashboard-main-' + [guid]::NewGuid());" ^
